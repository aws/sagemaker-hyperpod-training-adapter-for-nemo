...
class DummyDPODataModule(BaseDataModule):
    """
    Lightning DataModule for synthetic DPO data pipelining
    """

    def train_dataloader(self):
        vocab_size = self.get_vocab_size()
        self._train_ds = DummyDPODataset(vocab_size=vocab_size, seqlen=self.cfg.model.max_context_width)
