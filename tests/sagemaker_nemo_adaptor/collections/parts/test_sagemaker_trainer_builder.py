...
from sagemaker_nemo_adaptor.collections.parts.sagemaker_trainer_builder import (
...
class TestGetViztracerProfiler:
    ...
    def test_viztracer_not_supported(self):
        with patch("sagemaker_nemo_adaptor.collections.parts.sagemaker_trainer_builder.SUPPORT_VIZTRACER", False):
    ...
    @patch("sagemaker_nemo_adaptor.collections.parts.sagemaker_trainer_builder.VizTracerProfiler")
