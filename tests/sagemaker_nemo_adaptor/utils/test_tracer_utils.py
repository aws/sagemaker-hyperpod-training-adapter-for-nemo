...
class TestVizTracerProfiler(unittest.TestCase):
    ...
    @patch("sagemaker_nemo_adaptor.utils.tracer_utils.VizTracer")
    @patch("sagemaker_nemo_adaptor.utils.tracer_utils.install_all_hooks")
    @patch("signal.signal")
    ...
    @patch("sagemaker_nemo_adaptor.utils.tracer_utils.ReportBuilder")
