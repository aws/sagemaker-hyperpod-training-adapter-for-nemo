...
from hyperpod_nemo_adapter.collections.model.nlp import SageMakerMistralModel
...
def train(cfg: DictConfig) -> None:
    ...
    model_module = SageMakerMistralModel(cfg.model, trainer, use_smp_model=cfg.use_smp_model)
